<?php
session_start();
if (!isset($_SESSION['register_role']) || $_SESSION['register_role'] !== 'customer') {
    ...
    if (!filter_var($username, FILTER_VALIDATE_EMAIL)) {
        ...
        try {
            ...
            if ($exists > 0) {
                ...
                $_SESSION['register_customer']['username'] = $username;
                $_SESSION['register_customer']['password'] = $password;
                header("Location: customer_reg_3.php");
                exit;
            }
...
<main>
  <section class="card">
    ...
    <form method="post" action="customer_reg_2.php">
      ...
      <button type="button" class="btn" onclick="window.location.href='register.php'">Back</button>

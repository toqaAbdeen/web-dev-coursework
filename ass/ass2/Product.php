...
class Product {
    ...
    public function displayInTable() {
        ...
        $editAction = "<a href='edit.php?id={$this->product_id}'>
                         <button><img src='editProductInfo.png' alt='Edit' width='40'></button>
                       </a>";
        
                       $deleteAction = "<a href='delete.php?id={$this->product_id}' 
                       onclick='return confirm(\"Delete this product?\");'>
                      <button>
                          <img src='deleteProduct.png' alt='Delete' width='40'>
                      </button>
                   </a>";
  
    
        $imagePath = (!empty($this->image_name) && file_exists("images/{$this->image_name}")
                     ? "images/{$this->image_name}"
                     : "images/default.jpg");
    
        $imageTag = "<img src='{$imagePath}' alt='{$this->name}' 
